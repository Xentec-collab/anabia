    ...
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto py-4">
          <nav className="flex flex-col">
            ...
            >
              <span>Cart</span>
              {cartCount > 0 && (
                <span className="flex h-5 items-center justify-center bg-[var(--ink)] text-[var(--surface)] px-2 text-[11px] rounded-none">
                  {cartCount}
                </span>
              )}
            </Link>
        ...
        <div className="p-6 border-t border-[var(--line)]">
          <div className="flex space-x-4 text-[var(--muted)]">
